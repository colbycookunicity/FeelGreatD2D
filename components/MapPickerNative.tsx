...
interface MapPickerNativeProps {
  initialLat?: string;
  initialLng?: string;
}

export function MapPickerNative({ initialLat, initialLng }: MapPickerNativeProps) {
...
const styles = StyleSheet.create({
  ...
  cardAddress: { fontSize: 15, fontFamily: "Inter_600SemiBold" },
  cardCoords: { fontSize: 11, fontFamily: "Inter_400Regular" },
  confirmBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
